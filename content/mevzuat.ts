...
export const mevzuatParagraphs: string[] = [
  ...
  "d) Son iki ay içinde çekilmiş 4,5x6 cm. ebatlarında iki adet fotoğraf.",
  ...
  "MADDE 15",
  "– (1) Yapılan tüm tespit sözleşmelerine ilişkin bilgiler yetkilendirilmiş gümrük müşaviri tarafından, sözleşmenin yapıldığı tarihten itibaren en geç yedi iş günü içinde sistem vasıtasıyla gönderilir.",
